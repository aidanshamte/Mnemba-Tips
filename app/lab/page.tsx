...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Promise.resolve(context.registerTool({
      ...
      description: "Select a PitchPredict matchup and return its probability projection and lineup model.",
  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        <div className="brand"><span className="brand-icon"><Target size={21} /></span><div><strong>PitchPredict</strong><small>AI Studio</small></div></div>
