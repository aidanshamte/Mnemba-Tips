...
| `exploratory_estimates` | 0 | 1,649 | 518 | 1,715 | 1,715 | 1,815 |
...
| `field_claims` | 0 | 80,038 | 80,242 | 80,584 | 80,584 | 81,073 |
| `http_response_cache` | 0 | 209 | 26 | 229 | 229 | 237 |
...
Current Azure counts checked at **2026-09-17T09:49:20.164Z** after live job activity: **215,620 rows**. These new counts reflect ingestion, indexing, and existing retention rules; they are not the baseline content-hash assertion.
