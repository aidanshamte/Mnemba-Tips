export const publicViews = new Set(['matchday','shortlists','markets','prediction-history','overview','catalog','fixtures','news','search','global-search','match','match-context','analysis','entity','article','competition','badges','insights']);
