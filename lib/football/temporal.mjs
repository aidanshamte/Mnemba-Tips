...
export function originalAnalysis(f,history,context={}){
 const cutoff=context.asOf??f.startsAt,eligible=history.filter(g=>!g.hasConflict&&g.startsAt<Math.min(cutoff,f.startsAt));
