...
export class OpenFootballAdapter {
 ...
 async repositories(){const list=await this.http.json('openfootball','https://api.github.com/orgs/openfootball/repos?per_page=100');return list.filter(r=>r.license?.spdx_id==='CC0-1.0'&&!/^(clubs|players|help|docs|spec|schema|sandbox|quick-starter|league-starter|v0-format)/.test(r.name));}
